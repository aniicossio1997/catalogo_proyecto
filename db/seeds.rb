...
Item.create(product: Product.last, price: Product.last.price, count: rand(1..10), buy:  Buy.last)
# accepted
Item.create(product: Product.last, price: Product.last.price, count: rand(1..10), buy:  Buy.find(2))
Item.create(product: Product.last, price: Product.last.price, count: rand(1..10), buy:  Buy.find(2))
Item.create(product: Product.find(2), price: Product.find(2).price, count: rand(1..10), buy: Buy.find(2))
